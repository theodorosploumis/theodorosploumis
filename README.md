...
- [theodorosploumis/generate_drupal_report](https://github.com/theodorosploumis/generate_drupal_report) - A bash script that generates basic Drupal 8.x packages &amp; modules report in txt files. (1 week ago)
